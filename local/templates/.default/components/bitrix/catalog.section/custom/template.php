...
<div>
    <?php
    if (!empty($arResult['UF_FIELDS']['UF_CUSTOM_TEXT'])): ?>
        <div>
            <h3>Вывод простого текста</h3>
                <p><?= $arResult['UF_FIELDS']['UF_CUSTOM_TEXT'] ?></p>
        </div>
    <?php
    endif; ?>
    <?php
    if (!empty($arResult['UF_FIELDS']['UF_CUSTOM_MORE_TEXT'])): ?>
        <div>
            <h3>Вывод множественного текста</h3>
            <?php
            foreach ($arResult['UF_FIELDS']['UF_CUSTOM_MORE_TEXT'] as $text): ?>
                <p><?= $text ?></p>
            <?php
            endforeach; ?>
        </div>
    ...
    <?php
    if (!empty($arResult['UF_FIELDS']['UF_PHOTO'])): ?>
        <div>
            <h3>Вывод простого фото</h3>
            <p><img src="<?= $arResult['UF_FIELDS']['UF_PHOTO'] ?>"></p>
        </div>
    <?php
    endif; ?>

    <?php
    if (!empty($arResult['UF_FIELDS']['UF_MORE_PHOTO'])): ?>
        <div>
            <h3>Вывод множественного фото</h3>
            <?php
            foreach ($arResult['UF_FIELDS']['UF_MORE_PHOTO'] as $photo): ?>
                <p><img src="<?= $photo ?>"></p>
            <?php
            endforeach; ?>
        </div>
