...
$arParams['MESS_PRICE_RANGES_TITLE'] = $arParams['MESS_PRICE_RANGES_TITLE'] ?: Loc::getMessage(
    'CT_BCE_CATALOG_PRICE_RANGES_TITLE'
);
$arParams['MESS_DESCRIPTION_TAB'] = $arParams['MESS_DESCRIPTION_TAB'] ?: Loc::getMessage(
    ...
    <div class="bx-catalog-element<?= $themeClass ?>" id="<?= $itemIds['ID'] ?>" itemscope
                                                ...
                                                <div class="product-item-detail-economy-price mb-1"
                                                    ...
                                                    if ($showDiscount) {
                                                        echo Loc::getMessage(
                                                            ...
                                                            array('#ECONOMY#' => $price['PRINT_RATIO_DISCOUNT'])
                                                        );
                                                    }
                                                    ?></div>
                                                <?php
        ...
        <div class="row">
            <div class="col">
                ...
                <?php
                if (!empty($arResult['PROPERTIES']['CUSTOM_TEXT']['VALUE'])): ?>
                    <div>
                        <h3>Вывод простого текста</h3>
                        <p><?= $arResult['PROPERTIES']['CUSTOM_TEXT']['VALUE'] ?></p>
                    </div>
                <?php
                endif; ?>
                ...
                <?php
                if (!empty($arResult['PROPERTIES']['CUSTOM_MORE_TEXT']['VALUE'])): ?>
                    <div>
                        <h3>Вывод множественного текста</h3>
                        <?php
                        foreach ($arResult['PROPERTIES']['CUSTOM_MORE_TEXT']['VALUE'] as $text): ?>
                            <p><?= $text ?></p>
                        <?php
                        endforeach; ?>
                    </div>
                ...
                <?php
                if (!empty($arResult['PROPERTIES']['CUSTOM_PHOTO']['VALUE'])): ?>
                    <div>
                        <h3>Вывод простого фото</h3>
                        <p><img src="<?= CFile::GetPath($arResult['PROPERTIES']['CUSTOM_PHOTO']['VALUE']) ?>"></p>
                    </div>
                <?php
                endif; ?>

                <?php
                if (!empty($arResult['PROPERTIES']['CUSTOM_MORE_PHOTO']['VALUE'])): ?>
                    <div>
                        <h3>Вывод множественного фото</h3>
                        <?php
                        foreach ($arResult['PROPERTIES']['CUSTOM_MORE_PHOTO']['VALUE'] as $photo): ?>
                            <p><img src="<?= CFile::GetPath($photo) ?>"></p>
                        <?php
                        endforeach; ?>
                    </div>
                <?php
                    ...
                    <div data-entity="parent-container">
                        ...
                        if (!isset($arParams['GIFTS_DETAIL_HIDE_BLOCK_TITLE']) || $arParams['GIFTS_DETAIL_HIDE_BLOCK_TITLE'] !== 'Y') {
                            ...
                            <div class="catalog-block-header" data-entity="header" data-showed="false"
                                ...
                                <?= ($arParams['GIFTS_DETAIL_BLOCK_TITLE'] ?: Loc::getMessage(
                ...
                if ($arResult['CATALOG'] && $arParams['USE_GIFTS_MAIN_PR_SECTION_LIST'] == 'Y' && \Bitrix\Main\ModuleManager::isModuleInstalled(
                    ...
                    <div data-entity="parent-container">
                        ...
                        if (!isset($arParams['GIFTS_MAIN_PRODUCT_DETAIL_HIDE_BLOCK_TITLE']) || $arParams['GIFTS_MAIN_PRODUCT_DETAIL_HIDE_BLOCK_TITLE'] !== 'Y') {
                            ...
                            <div class="catalog-block-header" data-entity="header" data-showed="false"
                                 style="display: none; opacity: 0;">
                                <?= ($arParams['GIFTS_MAIN_PRODUCT_DETAIL_BLOCK_TITLE'] ?: Loc::getMessage(
